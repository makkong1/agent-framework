...
- 코드 작성·리뷰 전 **배경 규격은 늘 `CLAUDE.md`(기본 작업 스타일).** 같은 내용 **`/karpathy-guidelines`**로 다시 깔 수 있음(선택).
...
**다른 저장소:** Karpathy 원문 포함 **`docs/AGENT_TOOLING.md`** — 레거시에 Guideline 세 층 이식 시 사용.
